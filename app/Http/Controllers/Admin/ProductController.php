...
class ProductController extends Controller
{
    ...
    */
    ...
    {
        // CategoryProduct::whereIn('product_id',[67,68])->delete();
        // return 'ok';

        // return $this->productService->bulkActionByTypeAndIds('active',[3,4,8,9]);
        ...
        if (auth()->user()->can('product-view')){
            ...
            if (request()->ajax())
            {
                ...
                {
                    return Str::limit($row->productTranslation->product_name, 50, $end='...') ?? Str::limit($row->productTranslationEnglish->product_name, 50, $end='...');
                })
